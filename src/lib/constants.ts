...
export const KEYWORD_RECOMMENDATIONS: KeywordRecommendation[] = [
  {
    ...
    links: [
      {
        title: "피그마 슬라이드 템플릿 1",
        url: "https://www.figmapedia.co.kr/slide/?idx=5",
      },
      {
        title: "피그마 슬라이드 템플릿 2",
        url: "https://www.figmapedia.co.kr/slide/?idx=2",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        title: "이벤트 페이지 템플릿 - 행운의 포춘쿠키",
        url: "https://www.figmapedia.co.kr/event/?idx=4",
      },
      {
        title: "이벤트 페이지 템플릿 - 크리스마스 어드벤트 캘린더",
  ...
  for (const rec of KEYWORD_RECOMMENDATIONS) {
    if (
      rec.keywords.some((kw) =>
        q.includes(kw.toLowerCase().replace(/\s+/g, "")),
      )
    ) {

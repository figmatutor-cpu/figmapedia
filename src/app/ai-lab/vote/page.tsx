    ...
    <main className="min-h-screen bg-base">
      <div className="container mx-auto max-w-3xl px-6 py-12 md:py-16">
        <nav className="mb-8 flex items-center gap-2 text-xs text-gray-500">
          ...
          <span className="text-gray-400">주제 투표</span>
        </nav>
        ...
        <section className="mt-12 rounded-xl border border-border-1 bg-glass-1 p-5 text-xs leading-6 text-gray-500">
          <p className="font-medium text-gray-300">참여 규칙</p>

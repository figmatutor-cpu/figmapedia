  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/5 p-6 md:p-8">
      ...
      <dl className="mt-6 space-y-4 text-sm">
        <div>
          <dt className="text-xs text-gray-500">위치</dt>
          <dd className="mt-1 text-gray-200">{address}</dd>
        </div>
        <div>
          <dt className="text-xs text-gray-500">운영 시간</dt>
          <dd className="mt-1 text-gray-200">{hours}</dd>
        </div>
        <div>
          <dt className="text-xs text-gray-500">시간대</dt>

      ...
      <div className="relative rounded-2xl p-[2px] shadow-[0_1px_2px_0_rgba(0,0,0,0.06)] bg-linear-to-br from-white/10 via-white/5 to-black/20">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-2xl bg-[rgba(15,15,20,0.55)] border border-white/10 text-white placeholder:text-white/40 outline-none focus:ring-2 focus:ring-[#1f3dbc]/40 focus:border-[#1f3dbc]/40 backdrop-blur-md pl-12 pr-[100px] h-12 sm:h-14 text-[16px]"
            autoComplete="off"
            lang="ko"
          />
          <button
